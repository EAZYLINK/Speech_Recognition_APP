...
class AioHttpApi(AbstractAPI):
    ...
    async def get_request(cls, req):
        ...
        :param req: instance of aiohttp.templates.Request
    ...
    async def get_response(cls, response, mimetype=None, request=None):
        ...
        :type response: aiohttp.templates.StreamResponse | (Any,) | (Any, int) | (Any, dict) | (Any, int, dict)
        :rtype: aiohttp.templates.Response
        """
    ...
    def _build_response(cls, data, mimetype, content_type=None, headers=None, status_code=None, extra_context=None):
        if cls._is_framework_response(data):
            raise TypeError("Cannot return templates.StreamResponse in tuple. Only raw data can be returned in tuple.")
